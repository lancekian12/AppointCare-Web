...
const DoctorCard = () => {
    ...
    const doctorCard = info.filter((item) => {
        return search.trim().toLowerCase() === '' ||
            ...
            (item.municipality && item.municipality.toLowerCase().includes(search.toLowerCase())) ||
            (item.province && item.province.toLowerCase().includes(search.toLowerCase()));
    }).map((x) => {
            ...
            <div className='container'>
                <div className='inputBox_container'>
                    ...
                    <input
                        ...
                        id='inputBox'
                        type='text'
                        placeholder='Search for Doctors and Municipality or Provinces'
