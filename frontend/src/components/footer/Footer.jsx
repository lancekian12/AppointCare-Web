    ...
    <section>
      <footer className="align-items-center justify-content-center">
          ...
          <div className="row">
            ...
            <div className="col-2 flex-column justify-center links">
              ...
              <ul className="list-unstyled">
                ...
                <li className="nav-item nav2">
                  <NavLink to="/TopDoctors" className="nav-link">
                    Find Doctor
                  </NavLink>
                </li>
                <li className="nav-item nav2">
                ...
                {storedUserData && (
                  <li className="nav-item nav2">
                    <NavLink to="/PatientAppoinment" className="nav-link">
                      My Bookings
                    </NavLink>
                  </li>
                )}
                {storedUserData && (
                  <li className="nav-item nav2">
                    <NavLink to="/PatientConsultation" className="nav-link">
                      Consultation
                    </NavLink>
                  </li>
                )}
        ...
        <p className="copyright">
          Lance Kian Flores © 2023 - All Rights Reserved
        </p>
      </footer>
    </section>
  );
