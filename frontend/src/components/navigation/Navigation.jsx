...
//           </a>
//           <a href="/" className="navbar-brand">
//             <h1 id="LogoTitle" className="d-md-block">
//               Appoint<span id="LogoSubTitle">Care</span>
//             </h1>
//           </a>
//           <button
