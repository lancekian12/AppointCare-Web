        ...
        <div className="row">
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src={schedule} alt="schedule" />
          ...
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src={consult} alt="consult" />
          ...
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src={takeyourmedicine} alt="take your medicine" />
