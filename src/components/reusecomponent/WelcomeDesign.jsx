        ...
        <div className="row">
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src="schedule.png" alt="schedule" />
          ...
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src="consult.png" alt="consult" />
          ...
          <div className="col-4">
            <div className="three-design">
              <img className="mini-picture" src="takeyourmedicine.png" alt="take your medicine" />
